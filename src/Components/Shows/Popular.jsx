...
function Popular() {
    ...
    let getShows = async () => {
        let { data } = await axios.get("https://api.themoviedb.org/3/tv/popular?api_key=c479608cd31492c8dbd2552c8c9960e7&include_adult=false");
    ...
    return (
        <>
            <div className='my-5'>
                <h3 className="title mb-4">Popular TV-Series</h3>
                <div className="row">
                    {shows.map((show) =>
