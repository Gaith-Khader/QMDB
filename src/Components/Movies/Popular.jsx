...
function Popular() {
    ...
    let getMovies = async () => {
        let { data } = await api.get("https://api.themoviedb.org/3/movie/popular?api_key=c479608cd31492c8dbd2552c8c9960e7&page=1&include_adult=false");
    ...
    return (
        <>
            <div className='my-5'>
                <h3 className="title mb-4">Popular Movies</h3>
                <div className="row">
                    {movies.map((movie) =>
